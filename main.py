...
def main():
    ...
    if selected == "Temporadas":
        ...
        if opcao == "Brasileiro 2022":
            ...
            view.mostra_jogos(TEMPORADA_2022)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2022)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2022, ESTATISTICAS, 2022)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2021)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2021)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2021, ESTATISTICAS, 2021)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2020)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2020)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2020, ESTATISTICAS, 2020)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2019)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2019)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2019, ESTATISTICAS, 2019)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2018)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2018)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2018, ESTATISTICAS, 2018)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2017)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2017)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2017, ESTATISTICAS, 2017)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2016)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2016)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2016, ESTATISTICAS, 2016)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2015)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2015)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2015, ESTATISTICAS, 2015)
            st.markdown('---')
            ...
            st.markdown('---')
            st.title("Resumo Estatístico")
            view.mostra_jogos(TEMPORADA_2014)
            st.markdown('---')
            view.mostra_cartoes(TEMPORADA_2014)
            st.markdown('---')
            view.mostra_dados_ataques(TEMPORADA_2014, ESTATISTICAS, 2014)
            st.markdown('---')
